...
-- 4. Table des villes (3FN : la ville est externalisée pour éviter la
--    redondance et garantir l'intégrité référentielle).
CREATE TABLE cities (
    id          INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
-- 5. Table des artisans
-- Un artisan appartient à une seule spécialité (1,n) et à une seule ville (1,n)
...
-- 6. Journal des messages de contact (traçabilité côté plateforme)
...
-- 7. Vue pratique pour le frontend (lecture seule, jointures pré-faites)
